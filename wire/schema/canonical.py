...
class HTMLToCidsParser:
    INHERITABLE_PROPS = {
        ...
        'text-align', 'visibility', 'cursor', 'white-space', 'word-break'
    }
    ...
    @staticmethod
    def parse(soup_or_html, style_map: dict = None, interactions_map: dict = None, shadow_roots_map: dict = None) -> ComponentNode:
        ...
        return HTMLToCidsParser._process_node(root_element, style_map, None, interactions_map, shadow_roots_map) or ComponentNode(tag="div")

    @staticmethod
    def _process_node(node, style_map: dict, inherited_styles: dict = None, interactions_map: dict = None, shadow_roots_map: dict = None) -> Optional[ComponentNode]:
        ...
        if node.name in ["script", "style", "meta", "noscript", "link", "title", "head", "iframe", "object", "embed", "applet"]:
            return None
        ...
        if hasattr(node, "children"):
            for child in node.children:
                child_node = HTMLToCidsParser._process_node(child, style_map, next_inheritance, interactions_map, shadow_roots_map)
                if child_node:
